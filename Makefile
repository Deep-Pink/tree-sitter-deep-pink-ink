LANGUAGE_NAME := tree-sitter-deep-pink-ink
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-deep_pink_ink
VERSION := 0.1.0
DESCRIPTION := DeepPinkInk grammar for tree-sitter
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/deep-pink-ink '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/deep-pink-ink
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/deep-pink-ink
